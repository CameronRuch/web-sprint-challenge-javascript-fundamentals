...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
 // Since the variable 'internal' is located inside the parent function and the nestedFunction is nested in the parent function, the scope of 'internal' can be 
 // accessed by the nestedFunction
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(array){
    const popTot = array.reduce(function(acc, item){
...
let a = {"height": 5, "length": 4, "width": 5};
const cuboidTwo = new CuboidMakerTwo(a);
